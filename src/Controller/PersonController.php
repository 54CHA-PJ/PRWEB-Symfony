...
class PersonController extends AbstractController
{
    ...
    #[Route('/{person_id}', name: 'app_person_show', methods: ['GET'])]
    ...
    #[Route('/{person_id}/edit', name: 'app_person_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{person_id}', name: 'app_person_delete', methods: ['POST'])]
    public function delete(Request $request, Person $person, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$person->getPerson_id(), $request->request->get('_token'))) {
